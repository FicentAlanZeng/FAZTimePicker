...
[datePicker show];
  ...
  s.author             = { "zengyongqiang" => "alan.zy@qq.com" }
  # Or just: s.author    = "zengyongqiang"
  # s.authors            = { "zengyongqiang" => "alan.zy@qq.com" }
  # s.social_media_url   = "http://twitter.com/zengyongqiang"
